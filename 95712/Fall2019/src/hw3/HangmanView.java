 ...
 * @andrewID: qiuchenz
 * 
 * Build interface of the game Hangman.
 */
...
public class HangmanView extends GameView{
	...
	/**
	 * clears up previous game round and prepares the clueGrid  with new clue labels using the new clueWord.
	 * It also refreshes the keyboardButtons, disabling those buttons that have letters in the clue
	 * 
	 * @param hangmanRound: given GameRound
	 */
