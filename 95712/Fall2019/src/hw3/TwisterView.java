 ...
 * @andrewID: qiuchenz
 * 
 * Build interface of the game Twister.
 */
...
public class TwisterView extends GameView{
	...
	/**
	 * Sets up elements in bottomGrid
	 */
	...
	/**
	 * Clears up previous game round and refreshes all components with info in the new gameRound 
	 * 
	 * @param twisterRound: the given GameRound
	 */
