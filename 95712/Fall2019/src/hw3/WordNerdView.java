 ...
 * @andrewID: qiuchenz
 * 
 * Super class of HangmanView, TwisterView, ScoreView and SearchView,  set up some common views to them.
 */
...
public class WordNerdView {
	 ...
	 * 
	 * @param mainButtons four buttons for different boards
	 */
	...
	/**
	 * Sets up the style for exit button
	 */
