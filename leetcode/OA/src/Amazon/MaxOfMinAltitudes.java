...
public class MaxOfMinAltitudes {
	public static void main(String[] args) {
		...
		System.out.println("grid1: Expected: 4, Actual: " + maxScore1D(grid1));
		System.out.println("grid2: Expected: 4, Actual: " + maxScore1D(grid2));
		System.out.println("grid3: Expected: 1, Actual: " + maxScore1D(grid3) + " (if the first entry is not considered)");
		System.out.println("grid4: Expected: 8, Actual: " + maxScore1D(grid4) + " (same reason)");
		System.out.println("grid5: Expected: 3, Actual: " + maxScore1D(grid5));
	}
