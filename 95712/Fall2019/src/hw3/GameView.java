 ...
 * @andrewID: qiuchenz
 * 
 * Sets up the view parts common to both Hangman and Twister.Super class of HangmanView and TwisterView
 */
...
public abstract class GameView {
	...
	/**
	 * Constructor. It sets up the parts common to both Hangman and Twister.
	 * It creates the main grids, topMessageText and sets up the smileyButton.
	 */
	GameView() {
	...
	/**
	 * Initializes all smiley buttons with their images, sizes, styles, etc
	 */
