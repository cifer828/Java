 ...
 * AndrewID: qiuchenz
 * 
 * Hangman: Implement back-end logic of the game Hangman.
 * 
 */
...
public class Hangman extends Game{
   ...
   /*
	* setupRound(): Returns a new HangmanRound instance with puzzleWord initialized randomly drawn from wordsFromFile.
   ...
   /* 
    * makeAClue(): Returns a clue that has at least half the number of letters in puzzleWord replaced with dashes.
	...
	*/
	...
	/* 
	 * replaceChar(): Helper function of makeAClue().
	 * 				  Given a string as clue word and its no-dash version which removes all dashes in the clue word,
	 * 				  returns a final clue word that half of its characters are replaced by dash
	 */
	...
	/* 
	 * usedAllTrials(): Helper function of nextTry(), 
	 *                  returns true if trials are used up, false if not 
	 */
	...
	/* 
	 * usedAllTrials(): Helper function of nextTry(), 
	 *                  returns true if there's no dash in the clueWord, false if not 
	 */
	private boolean win() {
