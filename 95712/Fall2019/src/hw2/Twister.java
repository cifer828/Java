 ...
 * AndrewID: qiuchenz
 * 
 * Twister : Implement back-end logic of the game Twister.
 */
...
//		System.out.println(twisterRound.getSolutionWordsList()); 
   ...
   /* 
    * makeAClue(): Takes the puzzleWord as currently displayed in clueButtions,
    *              shuffles its letters to make a clue
	*/
	@Override
	...
	/* 
	 * getScoreString(): Returns a formatted String with calculated score to be displayed 
	 *                   in the topMessageText. 
	 */
	@Override
	...
	/* 
	 * nextTry(): Given a guess string, check its status, 
	 *            returns related index of smileyButton
	 */
	@Override
	...
	/* 
	 * findPuzzleWord(): Helper function of setupRound()
	 *                   Returns a new puzzle word randomly selected from the data file. 
	 */
	...
	/* 
	 * twisterSolution(): Helper function of setupRound()
	 *                    Returns all possible twister words from data file
	 */
	...
	/* 
	 * submittedCount(): Helper function for getScoreString() and nextTry(),
	 *                   Counts total words submitted by player
	 */
	...
	/* 
	 * solutionCount(): Helper function for getScoreString() and nextTry(),
	 *                  Count total word number of solutions.
	 */
